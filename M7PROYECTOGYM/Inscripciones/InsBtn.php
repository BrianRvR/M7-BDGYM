...
<div class="limiter">
    <div class="container-login100" style="background-image: url('../Bootstrap/images/bg-01.jpg');">
        <div style="width: 50%;" class="wrap-login100">
            <form class="login100-form validate-form" method="post" action="../Login/login-proceso.php">
                ...
                <div class="container-login100-form-btn">
                    ...
                    <a href="../Login/iniciosesion.php" class="login100-form-btn" style="font-size: 24px; width: 280px; height: 60px;">
                    Salir
                    </a>
                </div>
