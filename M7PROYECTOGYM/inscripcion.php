...
<body>
    ...
    <form method="post" action="registro-inscripcion.php">
        <label for="nombre_actividad">Nombre de la actividad:</label>
        <input type="text" id="nombre_actividad" name="nombre_actividad"><br><br>
        <label for="fecha_inscripcion">Fecha de inscripción:</label>
        <input type="date" id="fecha_inscripcion" name="fecha_inscripcion"><br><br>
        <input type="submit" value="Inscribirse">
    </form>-->
    <div class="limiter">
		<div class="container-login100" style="background-image: url('Bootstrap/images/body.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="registro-inscripcion.php" >
            ...
            <div class="wrap-login100" style="margin:20px; height: 644px;">
				<form class="login100-form validate-form">
                    ...
                    <div style="text-align:center; font-size:20px; border:2px solid white; padding:30px; width:80%; margin-left:10%; border-radius:10px">
                        <ul>
                            <li style="margin:20px; color:white;">Body Pump</li>
                            <li style="margin:20px; color:white;">Pilates</li>
                            <li style="margin:20px; color:white;">Spinning</li>
                            <li style="margin:20px; color:white;">Yoga</li>
